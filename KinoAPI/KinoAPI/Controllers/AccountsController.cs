...
namespace KinoAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager,IConfiguration configuration, IMapper mapper,AppDbContext context)
        {
